...
urlpatterns = [
    ...
    path('companies/<int:company_id>/vacancies', CompanyVacancy.as_view(), name='companyVacancies'),
    path('vacancies/', VacancyList.as_view(), name='vacancies'),
    path('vacancies/<int:pk>/', VacancyDetail.as_view(), name='vacancy_detail'),
    path('vacancies/top_ten/', VacancyTopTen.as_view(), name='vacancies_topTen'),
